---
name: coder
description: "Coder minion — Mid-tier (Sonnet) implement-only pipeline stage launcher. Slots into /ship stage 3 in place of cm for bounded, spec-driven implementation. Posture (implement-only) travels in the /ship spawn prompt."
model: sonnet
effort: low
---
