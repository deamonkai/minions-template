---
name: tester
description: "Tester minion — Mid-tier write-and-run-tests-only /ship stage launcher. Slots into /ship in place of cm for bounded test authoring and execution. Posture (test-only) travels in the /ship spawn prompt."
